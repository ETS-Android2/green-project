...
public class ProductionLineInspectionListAdapter extends BaseExpandableListAdapter {
    // attributes
    ...
    // constructor
    public ProductionLineInspectionListAdapter(ArrayList<ProductionLine> productionLines, Context context) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        AnyChartView anyChartView = v.findViewById(R.id.chartInspectionResults);
